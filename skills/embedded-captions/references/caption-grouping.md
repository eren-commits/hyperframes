...
```json
[
  { "id": "cg-0", "style": "intro",  "tone": "soft",    "words": ["You","know","for","me"],               "in": 0.10, "out": 1.45 },
  { "id": "cg-1", "style": "phrase", "tone": "soft",    "words": ["I've","had","this","kind","of","upbringing"], "in": 1.40, "out": 3.35 },
  { "id": "cg-2", "style": "phrase", "tone": "soft",    "words": ["the","great","foundation"],            "in": 3.50, "out": 5.35 },
  { "id": "cg-3", "style": "emph",   "tone": "present", "words": ["I've","achieved","incredible","things"], "in": 6.05, "out": 8.30 },
  { "id": "cg-4", "style": "dream",  "tone": "present", "words": ["dreaming","of","becoming","number","one"], "in": 8.50, "out": 10.40 }
]
```

Plus the crown:
```json
{ "id": "cg-crown", "style": "crown", "words": ["Wimbledon","Champion"], "in": 10.80, "out": 12.08 }
```
