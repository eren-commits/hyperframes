...
```css
.s-brut{--ff:'JetBrains Mono';--cfill:#f4f4f4;--cacc:#ff2d2d}
.s-brut .flow{font-weight:700;text-transform:uppercase;letter-spacing:-.02em}
.s-brut .climax{font-weight:700;font-size:42cqh;letter-spacing:-.05em}
```
