...
```css
.s-kid{--ff:'Fredoka';--cfill:#fff;--cacc:#ffd23f}
.s-kid .climax span{color:#ffd23f;-webkit-text-stroke:6px #241a3a;paint-order:stroke fill;text-shadow:0 5px 0 rgba(0,0,0,.3),0 9px 20px rgba(0,0,0,.35)}
```
