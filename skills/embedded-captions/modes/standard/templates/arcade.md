...
```css
.s-arcade{--ff:'Press Start 2P';--cfill:#fff;--cacc:#ffe600}
.s-arcade .flow{font-size:4.6cqh;line-height:1.7}
.s-arcade .climax{font-size:19cqh;color:#39ff14;line-height:1.4}
```
