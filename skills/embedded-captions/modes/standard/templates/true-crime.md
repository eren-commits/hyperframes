...
```css
.s-crime{--ff:'Special Elite';--cfill:#e8e4da;--cacc:#ff4d4d}
.s-crime .climax span{color:#ff3b3b;-webkit-text-stroke:1px rgba(0,0,0,.55);paint-order:stroke fill;text-shadow:0 2px 16px rgba(0,0,0,.8)}
```
